...
let NiceSelect = function( params ){
    this.obj = params.obj;
    ...
    core: function(){
        ...
        return {
            ...
            start: function(){
                ...
                self.text = $( '<span class="nice-select__item"></span>' );
                self.wrap = $( '<div class="nice-select"></div>' );
                self.window = $( window );
                self.opened = false;
            ...
            setMobileView: function(){
                self.wrap.addClass( 'nice-select_mobile' );
            },
            setCustom1: function(){
                self.wrap.addClass( 'nice-select_custom' );
            },
            destroy: function(){
                self.text.remove();
                self.wrap.unwrap();
            ...
            showPopup: function(){
                ...
                self.popup = $( '<div class="nice-select__popup" id="nice-select__popup' + self.id + '"></div>' );
                ...
                if( maxHeight > self.popup.find( 'li' ).eq( 0 ).outerHeight() * self.visible ){
                    ...
                    $('#nice-select__popup' + self.id).niceScroll({
                        cursorcolor:"#96c4ff",
                        cursoropacitymin: "1",
